...
par(mfrow=c(1,3))
hist(log(dat$likes_count),main="按讚人數分配",xlab="按讚人數(log)")
hist(log(dat$comments_count),main="回應人數分配",xlab="回應人數(log)")
hist(log(dat$shares_count),main="分享人數分配",xlab="分享人數(log)")
